> This are all available snippets for Vuetifyjs in Visual Studio Code. If you want to add another snippet which is useful for community. Just create an issue and I will know :)
...
- vToolbarProps -> v-toolbar props list
...
- vSystemBarProps -> v-system-bar props
### TOOLTIP
- vTooltip -> v-tooltip component
- vTooltipProps -> v-tooltip props list
